...
import {routes} from "@/utils/breadcrumbs";
// Types
interface Society {
  reraNumber: string;
  name: string;
  ...
  return (
    <div>
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        <CustomBreadcrumbs items={routes} />
      </div>
      <Box sx={{ bgcolor: "background.paper", width: "100%" }}>
        ...
        <TabPanel value={tabIndex} index={0} dir={theme.direction}>
          {!society ? (
            ...
            <Box>
              <Typography>
                Total Amount: ₹{societyReport.data.total.toLocaleString()}
              </Typography>
              <Typography>
                Paid Amount: ₹{societyReport.data.paid.toLocaleString()}
              </Typography>
              <Typography>
                Pending Amount: ₹{societyReport.data.pending.toLocaleString()}
              </Typography>
            </Box>
          ) : (
