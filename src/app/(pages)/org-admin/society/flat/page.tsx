...
const Page = () => {
    ...
    function formatINRTrunc(value: number) {
        const [intPart, decPart = ""] = String(value).split(".");
        // pad the decimal, then take exactly two characters
        const twoDec = (decPart + "00").slice(0, 2);
        // format the integer part with Indian separators
        const fmtInt = Number(intPart).toLocaleString("en-IN");
        return `${fmtInt}.${twoDec}`;
    }
