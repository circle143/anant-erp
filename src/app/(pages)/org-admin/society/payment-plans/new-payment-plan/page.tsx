...
import { PaymentPlanCreate } from "@/components/PaymentPlan/PaymentPlanCreate";
...
const Page = () => {
  ...
  const payment_plan = [
    ...
    {
      name: "Payment Plans",
      href: `/org-admin/society/payment-plans?rera=${rera}`,
    },
  ...
  return (
    ...
    >
      ...
      {rera && <PaymentPlanCreate societyRera={rera} />}
