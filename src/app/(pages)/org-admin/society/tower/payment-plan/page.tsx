...
const Page = () => {
  ...
  const fetchData = async (cursor: string | null = null, isNext = true) => {
    ...
    const response = await getTowerPaymentPlans(rera, towerID, cursor || "");
  ...
  const handleActivate = async (paymentId: string) => {
    ...
    const res = await markPaymentPlanActiveForTower(rera, towerID, paymentId);
            ...
            <>
              <ul className={styles.orgList}>
                {orgData.map((plan, index) => (
                  <li key={plan.id} className={styles.orgItem}>
                    <div className={styles.details}>
                      ...
                      <div>
                        <strong>Active:</strong> {plan.active ? "Yes" : "No"}
                      </div>
                      <div>
