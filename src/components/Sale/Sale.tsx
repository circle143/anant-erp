...
const StepOneSchema = Yup.object().shape({
  ...
  ifms: Yup.number()
    .typeError("IFMS must be a number")
    .min(0, "Value cannot be negative")
    .test("is-decimal", "Max 2 decimal places", (value) =>
      /^\d+(\.\d{1,2})?$/.test(String(value ?? 0)),
    ),
      ...
      plan.ratios.map((ratioObj: any) => {
        const itemRatios = ratioObj.items
          .map((item: any) => {
            ...
            return isNaN(parsed)
              ? null
              : String(parsed % 1 === 0 ? parsed.toFixed(0) : parsed);
          })
  ...
  const handleSubmit = async (values: any, { resetForm }: any) => {
    try {
      ...
      const otherCharges: OtherCharges[] = [
        ...
        {
          name: "Intrest Free Maintenance Security (IFMS)",
          totalCost: Number(ifms) || 0,
        },
                    ...
                    return (
                        <Form>
                          ...
                          <TextField
                            ...
                            onChange={(e) =>
                              setFieldValue("saleNumber", e.target.value)
                            }
                            // variant="outlined"
                            fullWidth
                            size="small"
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={
                            (e: any) =>
                              setFieldValue("paymentPlan", e.target.value) // ✅
                          }
                          displayEmpty
                          fullWidth
                          // className={styles.multiselect}
                          size="small"
                        >
                          <MenuItem value="">Select Payment Plan</MenuItem>
                      ...
                      <div>
                        ...
                        <TextField
                          id="floor-plc"
                          type="number"
                          value={values.floorPlc || ""}
                          onChange={(e) =>
                            setFieldValue("floorPlc", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                      ...
                      <div>
                        <label>Intrest Free Maintenance Security (IFMS):</label>
                        <TextField
                          id="ifms"
                          type="number"
                          value={values.ifms || ""}
                          onChange={(e) =>
                            setFieldValue("ifms", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                      ...
                      <div>
                        <label>External Development Charges (EDC):</label>
                        <TextField
                          id="edc"
                          type="number"
                          value={values.edc || ""}
                          onChange={(e) => setFieldValue("edc", e.target.value)}
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                        />
                      ...
                      <div>
                        <label>Fire Fighting Charges (FFC):</label>
                        <TextField
                          id="ffc"
                          type="number"
                          value={values.ffc || ""}
                          onChange={(e) => setFieldValue("ffc", e.target.value)}
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                        />
                      ...
                      <div>
                        <label>Electric Development Charges (EEC):</label>
                        <TextField
                          id="eec"
                          type="number"
                          value={values.eec || ""}
                          onChange={(e) => setFieldValue("eec", e.target.value)}
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                        />
                      ...
                      <div>
                        ...
                        <TextField
                          id="club-charges"
                          type="number"
                          value={values.clubCharges || ""}
                          onChange={(e) =>
                            setFieldValue("clubCharges", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                      ...
                      <div>
                        ...
                        <TextField
                          ...
                          onChange={(e) =>
                            setFieldValue("powerBackup", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                      ...
                      <div>
                        ...
                        <TextField
                          ...
                          onChange={(e) =>
                            setFieldValue("parkingCharges", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                      ...
                      <div>
                        <label>Maintenance Charges (MRMC):</label>
                        <TextField
                          id="maintenance-charges"
                          type="number"
                          value={values.maintenanceCharges || ""}
                          onChange={(e) =>
                            setFieldValue("maintenanceCharges", e.target.value)
                          }
                          fullWidth
                          size="small"
                          className={styles.multiselect}
                                                ...
                                                >
                                                    {skillOptions.map(
                                                        (option) => (
                                                            ...
                                                            >
                                                                <Checkbox
                                                                    checked={values.charges.includes(
                                                                        option.id
                                                                    )}
                                                                />
                                                                <ListItemText
